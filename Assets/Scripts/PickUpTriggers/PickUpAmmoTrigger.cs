...
public class PickUpAmmoTrigger : PickUpTrigger
{
   ...
   //{
    ...
    override public void PickUpObject(PickUpSystemTrigger WhoPicked)
    {
    ...
    */
    override public bool PickUpCriteria(PickUpSystemTrigger WhoPicked)
    {
        WeaponHolder cmp = WhoPicked.gameObject.GetComponentInChildren<WeaponHolder>();
